...
static const struct of_device_id mdp_rotator_of_match[] = {
	{ .compatible = "qcom,msm-rotator" },
	{ }
};
MODULE_DEVICE_TABLE(of, mdp_rotator_of_match);
...
static struct platform_driver msm_rotator_platform_driver = {
	...
	.driver = {
		.owner = THIS_MODULE,
		.name = DRIVER_NAME,
		.of_match_table = mdp_rotator_of_match,
	}
};
